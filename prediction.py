...
# ===================== 字体配置【关键修复：使用ReportLab内置字体，跨平台零报错】 =====================
# 不再加载系统字体，直接使用ReportLab原生字体，彻底解决Linux/Streamlit字体映射错误
